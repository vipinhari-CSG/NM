...
export declare class ButtonGroupComponent implements OnInit, OnDestroy, AfterContentChecked, AfterViewChecked, AfterContentInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ButtonGroupComponent, "kendo-buttongroup", ["kendoButtonGroup"], { "selection": "selection"; "tabIndex": "tabIndex"; "disabled": "disabled"; "width": "width"; }, { "navigate": "navigate"; }, ["buttons"], ["[kendoButton]"]>;
}
