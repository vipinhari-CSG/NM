...
export declare class ChipComponent implements OnInit, AfterViewInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ChipComponent, "kendo-chip", never, { "selected": "selected"; "removable": "removable"; "disabled": "disabled"; "size": "size"; "rounded": "rounded"; "fillMode": "fillMode"; "themeColor": "themeColor"; "label": "label"; "icon": "icon"; "iconClass": "iconClass"; "avatarClass": "avatarClass"; "removeIcon": "removeIcon"; }, { "remove": "remove"; "contentClick": "contentClick"; }, never, ["*"]>;
}
