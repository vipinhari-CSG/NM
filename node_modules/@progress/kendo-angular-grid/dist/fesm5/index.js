...
import { InjectionToken, HostBinding, Input, Component, Injectable, EventEmitter, Optional, Inject, Directive, SkipSelf, ElementRef, Renderer2, NgZone, ChangeDetectorRef, TemplateRef, isDevMode, ContentChildren, QueryList, ContentChild, forwardRef, Host, Output, SecurityContext, ViewChild, ViewChildren, ViewEncapsulation, Self, ViewContainerRef, Pipe, NgModule, ComponentFactoryResolver, HostListener, ChangeDetectionStrategy } from '@angular/core';
    ...
    Object.defineProperty(ColumnBase$$1.prototype, "width", {
        ...
        set: function (value) {
            if (typeof value === 'string') {
                var parsedValue = this._width = parseInt(value, 10);
                if (isDevMode()) {
...
var ColumnInfoService = /** @class */ (function () {
    ...
    Object.defineProperty(ColumnInfoService.prototype, "hiddenColumns", {
        get: function () {
            if (!this.list) {
                return [];
            }
            return this.list().filter(function (column) { return !column.isVisible; });
        },
        enumerable: true,
        configurable: true
    });
...
var LoadingTemplateDirective = /** @class */ (function () {
    ...
    LoadingTemplateDirective = __decorate([
        Directive({
...
var GridComponent = /** @class */ (function () {
    ...
    Object.defineProperty(GridComponent.prototype, "cellLoadingTemplate", {
        get: function () {
        ...
        set: function (cellLoadingTemplate) {
...
var isDeleteButton = or(hasClass('k-i-group-delete'), hasClass('k-icon-button'));
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.sortColumn = function (descriptor) {
    ...
    HeaderComponent.prototype.onSortClick = function (column, event, link) {
        ...
        var modifier = this.matchModifier(event);
        var toggledColumn = this.toggleSort(column, modifier);
    ...
    HeaderComponent.prototype.onHeaderKeydown = function (column, args) {
        ...
        if (args.keyCode === Keys.Enter && isPresent(column.field)) {
            var modifier = this.matchModifier(args);
     ...
     */
    HeaderComponent.prototype.toggleSort = function (column, modifier) {
        if (modifier === void 0) { modifier = true; }
     ...
     */
    HeaderComponent.prototype.matchModifier = function (event) {
        var multiSortKey = normalize$1(this.sortable).multiSortKey;
        if (multiSortKey === 'none') {
            return modifierKeys.every(function (key) { return !event[key + "Key"]; });
        }
...
var ColumnHandleDirective = /** @class */ (function () {
    function ColumnHandleDirective(draggable, element, service, zone, cdr, localization, columnInfoService) {
        this.draggable = draggable;
        this.element = element;
        this.service = service;
        this.zone = zone;
    ...
    ColumnHandleDirective.prototype.updateWidth = function (column, width) {
        column.width = width;
        this.columnInfoService.hiddenColumns.forEach(function (col) {
...
var SelectAllCheckboxDirective = /** @class */ (function () {
    ...
    SelectAllCheckboxDirective.prototype.onClick = function () {
        ...
        var shouldEmitSelectAll = hasObservers(this.selectAllChange);
