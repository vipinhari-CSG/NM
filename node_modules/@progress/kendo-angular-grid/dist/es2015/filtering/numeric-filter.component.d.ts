...
export declare abstract class NumericFilterComponent extends BaseFilterCellComponent implements FilterComponent, OnInit {
    ...
    */
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NumericFilterComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<NumericFilterComponent, never, never, { "operator": "operator"; "step": "step"; "spinners": "spinners"; "format": "format"; "column": "column"; "filter": "filter"; "min": "min"; "max": "max"; "decimals": "decimals"; }, {}, never>;
}
