...
export declare class GroupPanelComponent implements OnDestroy, OnInit, DoCheck {
    ...
    private leave;
    private drop;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<GroupPanelComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<GroupPanelComponent, "kendo-grid-group-panel", never, { "groups": "groups"; "text": "text"; }, { "change": "change"; }, never, never>;
}
