 ...
 * @hidden
 */
exports.findLastElement = function (node, predicate, matchSelf) {
    if (matchSelf === void 0) { matchSelf = true; }
    var last = null;
    exports.findElement(node, function (node) {
        if (predicate(node)) {
            last = node;
        }
        return false;
 ...
 * @hidden
 */
exports.findLastFocusableChild = function (element, checkVisibility) {
    if (checkVisibility === void 0) { checkVisibility = true; }
    return exports.findLastElement(element, function (node) { return exports.isFocusableWithTabKey(node, checkVisibility); }, false);
};
/**
 * @hidden
 */
