...
var ExpandGroupDirective = /** @class */ (function () {
    function ExpandGroupDirective(grid) {
        ...
        this.subscriptions.add(merge(this.grid.groupExpand.pipe(map(function (e) { return (tslib_1.__assign({ expand: true }, e)); })), this.grid.groupCollapse.pipe(map(function (e) { return (tslib_1.__assign({ expand: false }, e)); }))).subscribe(this.toggleState.bind(this)));
    }
