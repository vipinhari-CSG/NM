...
var SliderCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    SliderCustomMessagesComponent = SliderCustomMessagesComponent_1 = tslib_1.__decorate([
        core_1.Component({
            providers: [
                {
                    provide: messages_1.SliderMessages,
                    useExisting: core_1.forwardRef(function () { return SliderCustomMessagesComponent_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
