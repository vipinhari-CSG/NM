...
var RangeSliderCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    RangeSliderCustomMessagesComponent = RangeSliderCustomMessagesComponent_1 = tslib_1.__decorate([
        core_1.Component({
            providers: [
                {
                    provide: messages_1.RangeSliderMessages,
                    useExisting: core_1.forwardRef(function () { return RangeSliderCustomMessagesComponent_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
