...
exports.parseColor = function (value, format, opacityEnabled, safe) {
    ...
    var parsedColorResult = format === 'hex' ? exports.getHexValue(parsedColor, opacityEnabled) : parsedColor.toCssRgba();
 ...
 */
exports.getColorFromHSV = function (hsva, format, opacityEnabled) {
    ...
    var color = kendo_drawing_1.Color.fromHSV(hue, saturation, value, alpha);
    return format === 'hex' ? exports.getHexValue(color, opacityEnabled) : color.toCssRgba();
};
/**
 * @hidden
 *
