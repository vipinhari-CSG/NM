...
import { Injectable, InjectionToken, Inject, Optional, NgZone, isDevMode, EventEmitter, Input, Output, ViewChild, ElementRef, Component, Renderer2, TemplateRef, ApplicationRef, ComponentFactoryResolver, Injector, NgModule } from '@angular/core';
...
var AlignService = /** @class */ (function () {
    ...
    AlignService.prototype.alignElement = function (settings) {
        ...
        var elementRect = scaleRect(this._dom.offset(element.nativeElement), scale);
...
var ScrollableService = /** @class */ (function () {
        ...
        this._zone.runOutsideAngular(function () {
            ...
            var subscriber = function (e) {
                ...
                if (isParent || isDocument || isWindow) {
                    callback(_this.isVisible(_this.element, target));
                }
            };
    ...
    ScrollableService.prototype.isVisible = function (elem, container) {
        ...
        var containerRect = this._dom.boundingOffset(this._dom.nativeElement(container));
