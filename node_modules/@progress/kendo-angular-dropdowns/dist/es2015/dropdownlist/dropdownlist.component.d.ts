...
export declare class DropDownListComponent implements ControlValueAccessor, OnDestroy, OnChanges, AfterContentChecked, OnInit, FilterableComponent {
    ...
    role: string;
    readonly isAriaExpanded: boolean;
    readonly hostAriaOwns: string;
    readonly hostAriaActivedescendant: string;
    readonly hostNoDataLabel: string;
    /**
     * @hidden
     */
    ...
    private _rounded;
    private _fillMode;
    constructor(wrapper: ElementRef, localization: LocalizationService, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, disabledItemsService: DisabledItemsService, dataService: DataService, _zone: NgZone, renderer: Renderer2, cdr: ChangeDetectorRef, touchEnabled: boolean);
    ngOnInit(): void;
    /**
     * @hidden
     ...
     * @hidden
     */
    readonly selectButtonClasses: any;
    /**
     * @hidden
     */
    readonly filterInputClasses: any;
    /**
     * @hidden
     */
    readonly optionLabelSizeClass: any;
    /**
     * @hidden
     */
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<DropDownListComponent, "kendo-dropdownlist", ["kendoDropDownList"], { "listHeight": "listHeight"; "disabled": "disabled"; "readonly": "readonly"; "filterable": "filterable"; "ignoreCase": "ignoreCase"; "delay": "delay"; "tabindex": "tabindex"; "focusableId": "id"; "data": "data"; "value": "value"; "popupSettings": "popupSettings"; "itemDisabled": "itemDisabled"; "virtual": "virtual"; "valuePrimitive": "valuePrimitive"; "tabIndex": "tabIndex"; "size": "size"; "rounded": "rounded"; "fillMode": "fillMode"; "iconClass": "iconClass"; "loading": "loading"; "textField": "textField"; "valueField": "valueField"; "defaultItem": "defaultItem"; }, { "valueChange": "valueChange"; "filterChange": "filterChange"; "selectionChange": "selectionChange"; "open": "open"; "opened": "opened"; "close": "close"; "closed": "closed"; "onFocus": "focus"; "onBlur": "blur"; }, ["itemTemplate", "groupTemplate", "fixedGroupTemplate", "valueTemplate", "headerTemplate", "footerTemplate", "noDataTemplate"], never>;
}
