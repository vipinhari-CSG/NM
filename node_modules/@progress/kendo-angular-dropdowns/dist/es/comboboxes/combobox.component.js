...
var ComboBoxComponent = /** @class */ (function () {
    function ComboBoxComponent(wrapper, localization, popupService, selectionService, navigationService, disabledItemsService, dataService, zone, cdr, renderer, touchEnabled) {
    ...
    Object.defineProperty(ComboBoxComponent.prototype, "rounded", {
        get: function () {
    ...
    Object.defineProperty(ComboBoxComponent.prototype, "fillMode", {
        get: function () {
    ...
    Object.defineProperty(ComboBoxComponent.prototype, "isDisabled", {
        get: function () {
    ...
    Object.defineProperty(ComboBoxComponent.prototype, "isLoading", {
        get: function () {
            return this.loading;
        },
        enumerable: true,
     ...
     * @hidden
     */
    ComboBoxComponent.prototype.messageFor = function (key) {
    ...
    Object.defineProperty(ComboBoxComponent.prototype, "selectButtonClasses", {
        /**
         * @hidden
         */
        get: function () {
    ...
    ComboBoxComponent.prototype.handleBlur = function () {
        ...
        var runInZone = valueHasChanged || hasObservers(this.onBlur) || hasObservers(this.close) || isUntouched(this.wrapper.nativeElement);
        if (runInZone) {
    ...
    ComboBoxComponent.prototype.subscribeTouchEvents = function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            return _this.touchstartDisposeHandler = _this.renderer.listen(document, 'touchstart', function (e) {
                var target = e.target;
                var isInDropDown = inDropDown(_this.wrapper, target, _this.popupRef);
    ...
    ComboBoxComponent.prototype.setComponentClasses = function () {
        if (this.size) {
