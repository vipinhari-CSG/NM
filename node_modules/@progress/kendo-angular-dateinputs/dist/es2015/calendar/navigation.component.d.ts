...
export declare class NavigationComponent implements OnChanges, OnDestroy, AfterViewInit, AfterViewChecked {
    ...
    private getTake;
    private intlChange;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NavigationComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NavigationComponent, "kendo-calendar-navigation", never, { "min": "min"; "max": "max"; "focusedDate": "focusedDate"; "activeView": "activeView"; "templateRef": "templateRef"; }, { "valueChange": "valueChange"; "pageChange": "pageChange"; }, never, never>;
}
