 ...
 * @hidden
 */
exports.closestInScope = function (target, predicate, scope, targetAttr) {
 ...
 * @hidden
 */
exports.closestItem = function (target, targetAttr, scope) { return exports.closestInScope(target, hasItemIndex, scope, targetAttr); };
