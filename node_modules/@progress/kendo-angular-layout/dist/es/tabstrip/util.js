 ...
 */
export var isTabElement = function (target) {
 ...
 */
export var isTabClosable = function (tab, tabStripClosable) {
 ...
 */
export var tabStripHasScrollButtons = function (scrollableSettings) {
 ...
 */
export var mouseScrollEnabled = function (scrollableSettings) {
 ...
 */
export var getActiveTab = function (tabs) {
    var focusedTab;
    var selectedTab;
    var focusedIndex = -1;
    var selectedIndex = -1;
 ...
 * @hidden
 */
export var getTabByIndex = function (tabs, index) {
 ...
 * @hidden
 */
export var getTabHeaderByIndex = function (tabHeaderContainers, index) {
 ...
 * @hidden
 */
export var resetTabFocus = function (tabs) {
 ...
 * @hidden
 */
export var resetTabSelection = function (tabs) {
    tabs.forEach(function (tab) {
        tab.selected = false;
    });
};
 ...
 * @hidden
 */
export var isTablistHorizontal = function (tabPosition) {
