...
export declare class ScrollService {
    ...
    readonly scrollButtonIconClass: {
        prevScrollButton: string;
        nextScrollButton: string;
    };
    readonly tabstripSize: number;
    readonly tablistOverflowSize: number;
    readonly tabsOverflow: boolean;
    readonly scrollButtonsSize: number;
    ...
    emitScrollEvent(ev: any): TabScrollEvent;
...
//# sourceMappingURL=tabstrip-scroll.service.d.ts.map