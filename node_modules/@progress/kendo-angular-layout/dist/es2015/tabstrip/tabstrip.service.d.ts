...
export declare class TabStripService {
    ...
    onTabClose(tab: TabStripTabComponent, index: number): void;
    private onNavigate;
    private onDelete;
    private activateTab;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TabStripService, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<TabStripService>;
}

//# sourceMappingURL=tabstrip.service.d.ts.map