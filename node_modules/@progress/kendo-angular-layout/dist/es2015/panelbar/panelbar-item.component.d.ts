...
export declare class PanelBarItemComponent implements OnInit, AfterContentChecked, AfterViewChecked, OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PanelBarItemComponent, [{ optional: true; host: true; skipSelf: true; }, null, null, null]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PanelBarItemComponent, "kendo-panelbar-item", ["kendoPanelbarItem"], { "id": "id"; "icon": "icon"; "iconClass": "iconClass"; "imageUrl": "imageUrl"; "disabled": "disabled"; "selected": "selected"; "expanded": "expanded"; "title": "title"; "content": "content"; "items": "items"; "template": "template"; }, {}, ["contentItems", "contentTemplate", "titleTemplates"], ["kendo-panelbar-item"]>;
}

//# sourceMappingURL=panelbar-item.component.d.ts.map