...
export declare class TooltipDirective implements OnDestroy, OnChanges, AfterViewChecked {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TooltipDirective, [null, null, null, null, { optional: true; }, { optional: true; }]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<TooltipDirective, "[kendoTooltip]", ["kendoTooltip"], { "filter": "filter"; "position": "position"; "showAfter": "showAfter"; "callout": "callout"; "closable": "closable"; "offset": "offset"; "tooltipTemplate": "tooltipTemplate"; "showOn": "showOn"; "titleTemplate": "titleTemplate"; "tooltipWidth": "tooltipWidth"; "tooltipHeight": "tooltipHeight"; "tooltipClass": "tooltipClass"; "collision": "collision"; "closeTitle": "closeTitle"; }, {}, never>;
}
